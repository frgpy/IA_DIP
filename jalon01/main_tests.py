...
try:
    ...
    pass
try:
    from tests import test_periodique
except:
    print("failed test_periodique")
    pass
try:
    from tests import test_majorite
except:
...
try:
    ...
    pass
try:
    from tests import test_stochastique
except:
    print("failed test_stochastique")
    pass
try:
...
if __name__ == '__main__':
    ...
    _submenu = { '1': ("Stategie tactiques_jalon01",
                ...
                #'2': ("Periodique Majorite Markov Stochastique Automaton",
                #      [test_periodique, test_majorite, test_markov,
                #       test_stochastique, test_automaton]),
                #'3' : ("Mime Motif Shannon",
