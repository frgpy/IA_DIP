...
try:
    from evaluations import adaptive_evaluation as evaluation
except:
    from tools.evaluations import adaptive_evaluation as evaluation
...
class World:
    ...
    def __init__(self, lstOfStrat:Iterable, vicinity:Iterable,
        ...
        self.__pop = {x.idnum: x for x in lstOfStrat}
    ...
    def parameters(self):
        ...
        return tuple(self.__sim_params)
    @parameters.setter
